...
/**
 * @brief   Máscaras para seleccionar la configuración de la etapa de entrada o
 * salida de un pin.
 * @ingroup IOCON
 */
enum iocon_configuracion_es {
  IOCON_NO_PULL_UP_NO_PULL_DOWN =
      0, //!< No se habilita ninguna resistencia de pull-up/pull-down
  ...
  IOCON_HIDRIVE =
      (1u << 9),         //!< Habilitar HIDRIVE para modo Fast Mode Plus de I2C
...
typedef struct {
  LPC_GPIO_TypeDef
      *gpio_regs;        //!< Puntero a bloque de registros GPIO del puerto.
  uint32_t mascara_pin;  //!< Máscara de selección del pin.
  funcion_pin_t funcion; //!< Función deseada para el pin.

  /**
   * @brief   Configuración de pull-up/pull-down, modo analógico, histéresis,
