/**
 * @file   fuente.h
 * @brief  Tipos y constantes para el manejo de las fuentes para la pantalla
 * GLCD.
 *
...
typedef struct {
  ...
  const uint8_t
      *datos; //!< Puntero a los datos con el patrón de bits de los caracteres.
} fuente_t;

/**
 * @defgroup  Fuente_Macros_Publicas Fuente - Macros Públicas
 * @brief     Símbolos para definir el patrón de puntos de los diferentes
 * caracteres.
 * @{
 */
